module.exports = function (
	...
	Session.prototype._chroot = function (path) {
		if (path.charAt(0) !== '/') {
		// We don't use paths.join here, because under windows this will use \ instead of /.
		// Manually joining the paths is more reliable than trying to use paths.join and then
		// replacing \ with /.
